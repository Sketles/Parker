...
/* harmony import */ var _overlays_63b08852_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./overlays-63b08852.js */ "./node_modules/@ionic/core/dist/esm/overlays-63b08852.js");
...
/* harmony import */ var _button_active_f9f11302_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./button-active-f9f11302.js */ "./node_modules/@ionic/core/dist/esm/button-active-f9f11302.js");
...
const Alert = class {
    constructor(hostRef) {
        ...
        this.animated = true;
        this.onBackdropTap = () => {
            this.dismiss(undefined, _overlays_63b08852_js__WEBPACK_IMPORTED_MODULE_8__["B"]);
        };
    ...
    componentDidLoad() {
        ...
        this.gesture = Object(_button_active_f9f11302_js__WEBPACK_IMPORTED_MODULE_10__["c"])(this.wrapperEl, (refEl) => refEl.classList.contains('alert-button'));
    ...
    callButtonHandler(button, data) {
        if (button && button.handler) {
            ...
            const returnData = Object(_overlays_63b08852_js__WEBPACK_IMPORTED_MODULE_8__["s"])(button.handler, data);
            if (returnData === false) {
    ...
    renderInput(labelledby) {
        ...
        return (Object(_index_821f9ab1_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "alert-input-group", "aria-labelledby": labelledby }, inputs.map(i => {
            var _a, _b, _c, _d;
            if (i.type === 'textarea') {
    ...
    renderAlertButtons() {
        ...
        return (Object(_index_821f9ab1_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: alertButtonGroupClass }, buttons.map(button => Object(_index_821f9ab1_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", { type: "button", class: buttonClass(button), tabIndex: 0, onClick: () => this.buttonClick(button) }, Object(_index_821f9ab1_js__WEBPACK_IMPORTED_MODULE_0__["h"])("span", { class: "alert-button-inner" }, button.text), mode === 'md' && Object(_index_821f9ab1_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-ripple-effect", null)))));
    }
    render() {
