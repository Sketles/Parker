...
const Segment = class {
     ...
     */
    addRipple(detail) {
        const useRippleEffect = _ionic_global_f538b4cf_js__WEBPACK_IMPORTED_MODULE_1__["c"].getBoolean('animated', true) && _ionic_global_f538b4cf_js__WEBPACK_IMPORTED_MODULE_1__["c"].getBoolean('rippleEffect', true);
        if (!useRippleEffect) {
            return;
        }
        const buttons = this.getButtons();
...
const SegmentButton = class {
    ...
    render() {
        ...
        const mode = Object(_ionic_global_f538b4cf_js__WEBPACK_IMPORTED_MODULE_1__["b"])(this);
        return (Object(_index_821f9ab1_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_821f9ab1_js__WEBPACK_IMPORTED_MODULE_0__["H"], { "aria-disabled": disabled ? 'true' : null, class: {
                [mode]: true,
