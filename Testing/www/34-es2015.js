...
const Spinner = class {
    ...
    getName() {
        const spinnerName = this.name || _ionic_global_f538b4cf_js__WEBPACK_IMPORTED_MODULE_1__["c"].get('spinner');
    ...
    render() {
        const self = this;
        const mode = Object(_ionic_global_f538b4cf_js__WEBPACK_IMPORTED_MODULE_1__["b"])(self);
